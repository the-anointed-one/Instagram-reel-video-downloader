...
const PLATFORMS: PlatformConfig[] = [
    ...
    },
    {
        ...
        successMessage: 'X video ready to download!',
        gradient: 'from-zinc-700 to-zinc-900',
        iconColor: 'text-zinc-300',
        tabActive: 'border-zinc-500 text-zinc-300 bg-zinc-500/10',
        tabHover: 'hover:border-zinc-500/50 hover:text-zinc-400',
        icon: (
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
    ...
    },
    {
        ...
        pattern: /https?:\/\/(www\.)?pinterest\.com\/pin\/\d+|https?:\/\/pin\.it\/[A-Za-z0-9]+/,
        successMessage: 'Pinterest video ready to download!',
        gradient: 'from-red-700 to-rose-900',
        iconColor: 'text-rose-400',
        tabActive: 'border-rose-500 text-rose-400 bg-rose-500/10',
        tabHover: 'hover:border-rose-500/50 hover:text-rose-300',
        icon: (
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
